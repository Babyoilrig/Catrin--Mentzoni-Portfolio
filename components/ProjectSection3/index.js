...
export default function ProjectsSection3() {
  return (
    ...
    <div class="grid gap-0 grid-cols-1 md:grid-cols-6 grid-rows-1 place-items-center content-center border-solid border-2 border-black rounded-lg mb-12 mt-8 pb-[150px] pt-[50px]">
